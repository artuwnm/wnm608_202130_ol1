...
<body>
	...
	<div class="container">
		<div class="card soft">
			<h2 class="center">Product Checkout</h2>
			<form class="form">
			<h3>Address</h3>
				...
				<div class="form-control">
					<div class="grid gap">
						<div class="col-xs-12 col-md-6">
							<label for="address-zip" class="form-label">Zipe Code</label>
			...
			<h3>Payment</h3>
				...
				<div class="form-control">
					<div class="grid gap">
						...
						<div class="col-xs-12 col-md-6">
							...
							<input id="payment-cvv" type="text" placeholder="Payment CVV" class="form-input">
						</div>
					</div>
				</div>
				<div class="form-control">
				...
				<div class="form-control center">
					<a href="product_confirmation.php" class="form-button centers">Checkout</a>
				</div>
			</div>
			</form>
