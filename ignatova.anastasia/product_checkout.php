...
<!-- 	<p><a href="product_checkout.php">Checkout</a></p> -->
        ...
        <form class="form">
            <h3 style="margin: .5em 0em;">Address</h3>
    ...
    <div class="form-control">
        <div class="grid gap">
            ...
            <div class="col-xs-12 col-md-6"> 
                <label for="address-country" class="form-label">State</label>
...
<h3>Payment</h3>
 ...
 <div class="form-control">
                <label for="payment-number" class="form-label">Card Number</label>
                    <input id="payment-number" type="text" placeholder="XXXX-XXXX-XXXX-XXXX" class="form-input">
            </div>
<div class="form-control">
        <div class="grid gap">
            <div class="col-xs-12 col-md-6">   
                <label for="payment-expiration" class="form-label">Zip Code</label>
...
<div class="form-control">
                <label for="payment-zip" class="form-label">Full Name</label>
...
return $r."<div class='display-flex'>
    ...
    <div class='flex-stretch'>
        <div class='flex-stretch text-padding'>$o->brand_name</div>

        <div class='flex-none text-padding'>$o->name</div>
        </div>
        <div class='flex-none flex-end'>&dollar;$totalfixed</div>
        ...
        <?= cartTotals(); ?>
        <div class="form-control card-section display-flex flex-justify-center" style="padding: 0.7em 2em; margin: 0.7em;">
